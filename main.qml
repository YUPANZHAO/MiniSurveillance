...
Window {
    ...
    MouseArea {
        ...
        onWidthChanged: {
            if(talk_videoOutput.visible === true) {
                if(talk_videoOutput.x + talk_videoOutput.width > root.width) {
                    talk_videoOutput.x = root.width - talk_videoOutput.width
                }
                if(talk_videoOutput.y + talk_videoOutput.height > root.height) {
                    talk_videoOutput.y = root.height - talk_videoOutput.height
                }
            }
        }
        onHeightChanged: {
    ...
    VideoOutput {
        ...
        MouseArea {
            ...
            drag.minimumX: 0
            drag.minimumY: 0
            drag.maximumX: root.width - talk_videoOutput.width
            drag.maximumY: root.height - talk_videoOutput.height
        }
    }
